...
import 'package:flutter/services.dart'; // <-- Added for Text Limit
                      ...
                      if (authorized) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            ...
                            content: Text("INVALID OTP OR UNAUTHORIZED"),
                          ),
                        );
                      }
                    },
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            Text(
              "Details sent to Customer App.\nWaiting for 'APPROVED & ACCEPT'...",
              style: AXTheme.body,
              textAlign: TextAlign.center,
            ),
            const SizedBox(height: 50),
            CyberButton(
              text: "[SIMULATE] CUSTOMER ACCEPTS",
              onTap: _simulateCustomerAccept,
            ),
          ],
        ),
      ),
